...
namespace FunkoMania.API.Controllers.V1
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<ActionResult<ProductViewModel>> Get(CategoryOptions? category)
        {
            var result = await _productAppService.SearchAsync(c => c.Category == category);
            return Ok(result);
        ...
        public ActionResult SedDecreaseStock(Guid productId, int quantity)
        {
            try
            {
